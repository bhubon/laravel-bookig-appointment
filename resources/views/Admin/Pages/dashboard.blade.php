        ...
        <div class="row row-sm mg-t-20">
            <div class="col-xl-8">
                ...
                <div class="card pd-20 pd-sm-25 mg-t-20">
                    ...
                    <p class="mg-b-20 mg-sm-b-30">A bar chart or bar graph is a chart with rectangular bars with
                        lengths proportional to the values that they represent.</p>
                ...
                <div class="card widget-messages mg-t-20">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="" class="list-group-item list-group-item-action media">
                            <img src="{{ asset('assets') }}/img/img10.jpg" alt="">
                        ...
                        <a href="" class="list-group-item list-group-item-action media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="msg-summary">On the other hand, we denounce with righteous indignation
                                    and dislike...</p>
                            </div><!-- media-body -->
                        </a><!-- list-group-item -->
                        <a href="" class="list-group-item list-group-item-action media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="msg-summary">It is a long established fact that a reader will be
                        ...
                        <a href="" class="list-group-item list-group-item-action media">
                            ...
                            <div class="media-body">
                                ...
                                <p class="msg-summary">Than the fact that climate change may be causing it to
                                    rapidly disappear... </p>
                            </div><!-- media-body -->
                        </a><!-- list-group-item -->
                    </div><!-- list-group -->
                    <div class="card-footer">
                        <a href="" class="tx-12"><i class="fa fa-angle-down mg-r-3"></i> Load more
                            messages</a>
                    </div><!-- card-footer -->
                </div><!-- card -->
            </div><!-- col-3 -->
