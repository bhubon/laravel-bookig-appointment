        ...
        <div class="col-lg-6 col-md-7 position-static p-4">
          <div class="log_wraps">
            ...
            <div class="log__heads">
              <h4 class="mt-0 logs_title">Please <span class="theme-cl">sign-in</span></h4>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login') }}">
              ...
              <div class="form-group">
                <a href="{{ route('admin.forget.password.get') }}"><span>Forgot Password?</span></a>
              </div>

              <div class="form-group">
                <button type="submit" class="w-100" style="display: inline-block; text-align: center; padding: 20px; background-color: #DA0B4E; color: #FFFFFF; border: none; border-radius: 4px; text-decoration: none;">Sign In</button>
              </div>
            </form>
            ...
            <div class="form-group text-center mb-0 mt-3">
              New on our platform? <a href="{{ route('admin.register') }}" class="theme-cl">Create an account</a>
            </div>
